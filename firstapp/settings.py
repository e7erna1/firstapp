...
SECRET_KEY = 'fhhl#16f-&b08iktv&rsie&md@p%m$^+=7wn_$ndctz*r%z+m)'
...
TEMPLATES = [
    {
        ...
        'DIRS': ['/home/oleg/djangoenv/bin/firstapp/templates',
                 '/home/oleg/djangoenv/bin/firstapp/article/templates'],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
STATICFILES_DIRS = [
    ('static', '/home/oleg/djangoenv/bin/firstapp/static'),
]
